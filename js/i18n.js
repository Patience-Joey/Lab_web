(function () {
  ...
  const translations = {
    ...
    'SemCityLoc：利用语义三维城市模型实现无人机六自由度定位': 'SemCityLoc: Aerial 6DoF localization using semantic 3D city models.',
    ...
    '我们的论文AUVIC被AAAI 2026接收': 'AUVIC Accepted by AAAI 2026',
    'AUVIC：面向多模态大语言模型的视觉概念对抗式遗忘方法': 'AUVIC: Adversarial unlearning of visual concepts for multimodal large language models.',
    'AUVIC 视觉概念遗忘方法概览图': 'AUVIC visual concept unlearning method overview',
    '我们的论文TRASE被3DV 2026接收': 'TRASE Accepted by 3DV 2026',
    'TRASE：面向动态场景理解的免跟踪四维分割与编辑方法': 'TRASE: Tracking-free 4D segmentation and editing for dynamic scene understanding.',
    'TRASE 4D分割与编辑概览图': 'TRASE 4D segmentation and editing overview',
    ...
    '我们的论文ICQ被CVPR 2025接收': 'ICQ Accepted by CVPR 2025',
    'ICQ：面向多模态查询的视频事件定位新基准与自适应方法': 'ICQ: A new benchmark and adaptation methods for localizing events in videos with multimodal queries.',
    'ICQ 多模态查询视频事件定位概览图': 'ICQ multimodal query video event localization overview',
    ...
    '研究方向：空间智能、三维计算机视觉、自动驾驶': 'Research: spatial intelligence, 3D computer vision, and autonomous driving.',
    ...
    '曹学伟，中国科学技术大学智能科学与技术专业博士研究生，剑桥大学访问博士生，研究方向为空间智能、三维计算机视觉与自动驾驶。': 'Xuewei Cao is a PhD student in Intelligent Science and Technology at USTC and a visiting PhD student at the University of Cambridge. His research focuses on spatial intelligence, 3D computer vision, and autonomous driving.',
