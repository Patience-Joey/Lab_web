(function () {
  ...
  const translations = {
    ...
    '杨家越，中国科学技术大学计算机科学与技术专业本科生，研究兴趣包括三维计算机视觉、低多边形三维表示与物理信息驱动的四维预测。': 'Jiayue Yang is an undergraduate in Computer Science and Technology at USTC. His research interests include 3D computer vision, low-poly 3D representations, and physics-informed 4D prediction.',
